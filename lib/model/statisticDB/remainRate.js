...
let queryRemainInfoImpl = P.coroutine(function* queryRemainInfoImpl(date) {
...
exp.queryRemainInfo = function(date) {

  // return onebyone.addAsync(function(cb) {
  //   queryRemainInfoImpl(date).then(function(res) {
  //     cb(null, res);
  //   });
  // });

  return queryRemainInfoImpl(date);
}
...
// exp.login = P.coroutine(function* login(userId, time) {
...
//   return mysqlUtil.query(sql, sqlArgs);
// })
